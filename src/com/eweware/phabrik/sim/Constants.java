...
//      EARTH_ACCELERATION		(981.0)			/* Units of cm/sec2			*/
    ...
    public static double EARTH_SURF_PRES_IN_MMHG	 =(760.)	;		/* Dole p. 15				*/
    ...
    public static double H20_ASSUMED_PRESSURE =	(47. * MMHG_TO_MILLIBARS); /* Dole p. 15      */
    public static double MIN_O2_IPP =	(72. * MMHG_TO_MILLIBARS);	/* Dole, p. 15				*/
    public static double MAX_O2_IPP =	(400. * MMHG_TO_MILLIBARS);	/* Dole, p. 15				*/
    public static double MAX_HE_IPP =	(61000. * MMHG_TO_MILLIBARS);	/* Dole, p. 16			*/
    public static double MAX_NE_IPP =	(3900. * MMHG_TO_MILLIBARS);	/* Dole, p. 16				*/
    public static double MAX_N2_IPP =	(2330. * MMHG_TO_MILLIBARS)	;/* Dole, p. 16				*/
    public static double MAX_AR_IPP =	(1220. * MMHG_TO_MILLIBARS);	/* Dole, p. 16				*/
    public static double MAX_KR_IPP =	(350. * MMHG_TO_MILLIBARS);	/* Dole, p. 16				*/
    public static double MAX_XE_IPP =	(160. * MMHG_TO_MILLIBARS);	/* Dole, p. 16				*/
    public static double MAX_CO2_IPP  = (7. * MMHG_TO_MILLIBARS);	/* Dole, p. 16				*/
...
//      FREEZING_POINT_OF_WATER (273.0)			/* Units of degrees Kelvin	*/
    public static double FREEZING_POINT_OF_WATER = (273.15)	;	/* Units of degrees Kelvin	*/
//      EARTH_AVERAGE_CELSIUS   (15.5)			/* Average Earth Temperature */
    public static double EARTH_AVERAGE_CELSIUS =   (14.0)		;	/* Average Earth Temperature */
...
//		gas_retention_threshold = 5.0;  		/* ratio of esc vel to RMS vel */
    public static double GAS_RETENTION_THRESHOLD = (6.0)	;		/* ratio of esc vel to RMS vel */
...
//public static double MILLIBARS_PER_BAR		(1013.25)
    public static double MILLIBARS_PER_BAR =		(1000.00);
